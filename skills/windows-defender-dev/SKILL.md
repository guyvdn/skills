...
description: 'Use this skill when the user mentions slow builds, Defender slowing down compilation, IntelliSense lag, antivirus scanning build output, VS Code extensions loading slowly, or asks to configure Windows Defender exclusions for a developer machine. Also use when setting up a new Windows dev machine with Visual Studio, VS Code, JetBrains Rider, SSMS, .NET, or NuGet.'
version: 1.0.0
---
